...
pub fn build_cli() -> ClapCommand {
    ClapCommand::new("isolate")
        ...
        .subcommand(cmd_init())
        .subcommand(cmd_add())
        // .subcommand(cmd_agents()) // TODO: fix or remove - not in object_commands
        // .subcommand(cmd_broadcast()) // TODO: fix or remove - not in object_commands
        .subcommand(cmd_list())
    ...
    // NOTE: cmd_pane was removed - pane commands are handled elsewhere
