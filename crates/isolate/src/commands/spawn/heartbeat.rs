...
const HEARTBEAT_FILE: &str = ".isolate/heartbeat";
...
"
    ...
    let instructions_path = workspace_path.join(".isolate/HEARTBEAT.md");
...
mod tests {
    ...
    async fn test_write_heartbeat_instructions() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let instructions_path = workspace.join(".isolate/HEARTBEAT.md");
