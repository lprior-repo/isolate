...
// ═══════════════════════════════════════════════════════════════════════════
// OUTPUT SCHEMAS (bd-3am: isolate://submit-response/v1)
// ═══════════════════════════════════════════════════════════════════════════
...
pub struct SubmitResponse {
    /// Schema URI: "<isolate://submit-response/v1>"
    pub schema: String,
    /// Success flag
    pub ok: bool,
...
mod tests {
    ...
    fn test_submit_response_success_schema() {
        ...
        assert_eq!(response.schema, "isolate://submit-response/v1");
        assert!(response.ok);
    ...
    fn test_submit_response_json_serialization() {
        ...
        assert!(json_str.contains("\"schema\":\"isolate://submit-response/v1\""));
