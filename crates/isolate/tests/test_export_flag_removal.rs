...
//! Tests for --include-files flag removal (isolate-xcso)
//!
...
async fn cli_rejects_include_files_flag() {
    ...
    let output = Command::new(&harness.isolate_bin)
        .args(["export", "--include-files"])
        .current_dir(&harness.current_dir)
        .env("NO_COLOR", "1")
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export --include-files");
...
async fn export_works_without_include_files_flag() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export");
...
fn export_options_no_include_files_field() {
    ...
    //    crates/isolate/src/commands/export_import.rs
...
async fn export_help_text_no_tarball_mention() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export --help");
...
async fn cli_rejects_file_path_without_output_flag() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export backup.json");
...
async fn cli_accepts_output_flag_with_file_path() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export -o backup.json");
...
async fn cli_accepts_valid_session_names() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export feature-branch");
...
async fn cli_rejects_path_like_argument_without_output_flag() {
    ...
    let output = Command::new(&harness.isolate_bin)
        ...
        .env("Isolate_TEST_MODE", "1")
        .output()
        .expect("Failed to execute isolate export /tmp/backup");
