...
fn bdd_query_contract_flag_does_not_panic() {
    ...
    //   When I run "isolate query --contract"
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("AI CONTRACT for isolate query"))
...
fn bdd_query_ai_hints_flag_does_not_panic() {
    ...
    //   When I run "isolate query --ai-hints"
