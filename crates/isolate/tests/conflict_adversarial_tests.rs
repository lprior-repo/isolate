...
fn adv_001_files_analyzed_double_count() {
    ...
    let result = harness.isolate(&["add", "feature-overlap"]);
    if !result.success {
        return;
    }
    ...
    let result = harness.isolate(&["status", "--json"]);
    if !result.success {
        return;
    }
...
fn adv_002_merge_safe_without_merge_base() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-no-base"]);
    if !result.success {
        return;
    }
...
fn adv_003_timing_boundary_zero() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-timing-zero"]);
    if !result.success {
        return;
    }
...
fn adv_004_unicode_file_paths() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-unicode"]);
    if !result.success {
        return;
    }
...
fn adv_005_very_long_file_paths() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-longpath"]);
    if !result.success {
        return;
    }
...
fn adv_006_has_conflicts_consistency() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-consistency"]);
    if !result.success {
        return;
    }
...
fn adv_007_empty_file_lists() {
    ...
    harness.assert_success(&["init"]);
    let result = harness.isolate(&["add", "feature-empty"]);
    if !result.success {
        return;
    }
