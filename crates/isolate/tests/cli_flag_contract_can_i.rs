...
fn bdd_can_i_contract_flag_does_not_panic() {
    ...
    //   When I run "isolate can-i --contract add"
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("AI CONTRACT for isolate can-i"))
...
fn bdd_can_i_contract_with_different_actions() {
    ...
    //   When I run "isolate can-i --contract done"
