...
//!
//! This module provides controlled chaos injection for testing how isolate handles
...
impl ChaosTestHarness {
    ...
    /// Run a isolate command with potential chaos injection
    ///
    /// # Examples
    ///
    /// ```no_run
        ...
        paste::paste! {
            $(
                ...
                fn [<$test_name _prob $iterations _seed $iterations>]() {
                    ...
                    let _result = harness.isolate_with_chaos($cmd);
