...
fn bdd_status_contract_flag_does_not_panic() {
    ...
    //   When I run "isolate status --contract"
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("AI CONTRACT for isolate status"))
...
fn bdd_status_ai_hints_flag_does_not_panic() {
    ...
    //   When I run "isolate status --ai-hints"
...
fn bdd_status_with_invalid_session_still_works() {
    ...
    //   When I run "isolate status --contract nonexistent-session"
...
fn bdd_status_without_flags_runs_normally() {
    ...
    //   When I run "isolate status --help"
...
fn bdd_status_watch_starts_without_panic() {
    ...
    //   When I run "isolate status --watch"
...
fn bdd_status_watch_flag_does_not_panic() {
    ...
    //   When I run "isolate status --help" to verify flag exists
