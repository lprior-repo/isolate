...
fn bdd_pane_focus_contract_flag_does_not_panic() {
    ...
    //   When I run "isolate pane focus test-session --contract"
...
fn bdd_pane_focus_ai_hints_flag_does_not_panic() {
    ...
    //   When I run "isolate pane focus test-session --ai-hints"
...
fn bdd_pane_focus_help_shows_new_flags() {
    ...
    //   When I run "isolate pane focus --help"
...
fn bdd_pane_focus_with_direction_flag() {
    ...
    //   When I run "isolate pane focus test-session --direction left"
