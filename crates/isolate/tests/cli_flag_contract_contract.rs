...
fn bdd_contract_contract_flag_does_not_panic() {
    ...
    //   When I run "isolate contract --contract"
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("AI CONTRACT for isolate contract"))
...
fn bdd_contract_contract_flag_with_command_arg() {
    ...
    //   When I run "isolate contract add --contract"
...
fn bdd_contract_help_shows_contract_flag() {
    ...
    //   When I run "isolate contract --help"
...
fn bdd_contract_normal_operation_still_works() {
    ...
    //   When I run "isolate contract add"
