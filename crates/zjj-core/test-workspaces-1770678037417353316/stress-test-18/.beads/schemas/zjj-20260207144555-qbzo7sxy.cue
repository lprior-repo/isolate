...
// Validation schema for bead: zjj-20260207144555-qbzo7sxy
// Title: agents: Reject empty agent IDs
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260207144555-qbzo7sxy.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260207144555-qbzo7sxy"
  title: "agents: Reject empty agent IDs"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Agent registration with valid ID succeeds",
      "Agent ID with alphanumeric characters accepted",
      "Exit code 0 on successful registration",
    ]

    // Required error path tests
    required_error_tests: [
      "Empty string agent ID is rejected",
      "Whitespace-only ID is rejected",
      "Error message specifies that ID cannot be empty",
    ]
  }
