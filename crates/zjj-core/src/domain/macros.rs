...
///
/// ```rust
/// use zjj_core::domain::{BeadError, assert_invariant};
///
...
///
/// ```rust
/// use zjj_core::domain::{BeadError, debug_invariant};
///
...
mod example_tests {
    ...
    impl std::fmt::Display for TestError {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            match self {
                TestError::InvariantViolated(msg) => write!(f, "Invariant violated: {msg}"),
            }
        }
    }
