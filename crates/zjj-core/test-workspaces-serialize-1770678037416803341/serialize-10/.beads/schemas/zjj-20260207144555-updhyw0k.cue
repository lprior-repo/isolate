...
// Validation schema for bead: zjj-20260207144555-updhyw0k
// Title: bookmark: Fix bookmark delete fails
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260207144555-updhyw0k.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260207144555-updhyw0k"
  title: "bookmark: Fix bookmark delete fails"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Deleting existing bookmark succeeds",
      "Deleted bookmark no longer appears in list",
      "Exit code 0 on successful deletion",
    ]

    // Required error path tests
    required_error_tests: [
      "Deleting non-existent bookmark returns error",
      "Parser handles multi-line format before deletion",
      "Invalid bookmark name returns appropriate error",
    ]
  }
