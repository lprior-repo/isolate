//! Tests for bd-36v: Analyze merge conflicts and emit structured resolution options
//!
//! This test module verifies the conflict analysis system can:
//! - Analyze conflicts and generate structured output
//! - Provide appropriate resolution options per conflict type
//! - Emit valid JSONL output for AI consumption
