...
//!
//! Run with: `cargo test --package zjj-core --test doctor_properties
...
use zjj_core::introspection::{CheckStatus, DoctorCheck, DoctorOutput, FixResult};
...
fn check_name_strategy() -> impl Strategy<Value = String> {
    prop_oneof![
        ...
        Just("zjj Initialized".to_string()),
