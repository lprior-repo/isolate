...
/// Setup configuration files in the .jjz directory
///
/// Creates:
...
pub fn setup_config(zjj_dir: &Path) -> Result<()> {
    ...
    fs::write(&config_path, DEFAULT_CONFIG)
        ...
        .context("  - Ensure the .jjz directory was created successfully")
    ...
    fs::create_dir_all(&layouts_dir)
        ...
        .context("  - Ensure the .jjz directory exists and is writable")?;
