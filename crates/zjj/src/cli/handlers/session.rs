...
//!
//! This module provides the main dispatcher for `zjj session <action>` commands,
...
///
/// Routes `zjj session <action>` commands to their handlers.
            ...
            if format.is_json() {
                let help_json = serde_json::json!({
                    ...
                    "subcommands": [
                        ...
                        {"name": "init", "description": "Initialize zjj in repository"},
                    ]
                });
                ...
                println!();
                println!("  zjj session list [--all]                List all sessions");
                println!("  zjj session add <name>                  Create a new session");
                println!("  zjj session remove <name>               Remove a session");
                println!("  zjj session focus <name>                Switch to a session");
                println!("  zjj session pause [name]                Pause a session");
                println!("  zjj session resume [name]               Resume a paused session");
                println!("  zjj session clone <name>                Clone a session");
                println!("  zjj session rename <old> <new>          Rename a session");
                println!("  zjj session attach <name>               Attach to session from shell");
                println!("  zjj session spawn <bead>                Spawn session for agent work");
                println!("  zjj session sync [name]                 Sync session with remote");
                println!("  zjj session init                        Initialize zjj in repository");
                println!();
                println!("Run 'zjj session <command> --help' for more information.");
            }
            Ok(())
        }
    }
