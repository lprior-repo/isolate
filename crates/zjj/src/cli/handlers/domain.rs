...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//
// WorkspaceName is now defined in `zjj_core::domain::identifiers` as the
...
mod tests {
    ...
    fn test_session_name_empty() {
        ...
        assert_eq!(
            result.unwrap_err(),
            DomainError::InvalidSessionName("".to_string(), "cannot be empty".to_string())
        );
    }
    ...
    // BeadId tests
    // BeadId is now re-exported from zjj_core::domain (alias to TaskId)
