...
pub fn generate_command_docs() -> HashMap<String, CommandDocumentation> {
    ...
    commands.insert("init".to_string(), CommandDocumentation {
        ...
        usage: "zjj init [OPTIONS]".to_string(),
        arguments: vec![],
        options: vec![
            OptionDoc {
                name: "json".to_string(),
        ...
        examples: vec![
            Example {
                ...
                use_case: "Initialize zjj in a new repository".to_string(),
            },
            Example {
                command: "zjj init --repair".to_string(),
                description: "Fix database corruption".to_string(),
                use_case: "Repair corrupted session database".to_string(),
            },
            Example {
                command: "zjj init --force".to_string(),
        ...
        ai_guidance: "Run this ONCE per repository. Check exit code: 0 = success, 1 = user error, 2 = system error. Run 'zjj doctor' after init to verify setup.".to_string(),
        state_changes: vec![
            StateChange {
            ...
            StateChange {
                ...
                reversible: true,
                reverse_command: Some("zjj init --force".to_string()),
            },
            StateChange {
    ...
    commands.insert("add".to_string(), CommandDocumentation {
        ...
        usage: "zjj add [OPTIONS] <name>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: true,
        ...
        examples: vec![
            ...
            Example {
                command: "zjj add bugfix-123 --no-open".to_string(),
        ...
        prerequisites: vec![
            "Must be in a JJ repository (run 'zjj init' first)".to_string(),
        ...
        ai_guidance: "Use --dry-run first to preview. Use --json for structured output. Check 'zjj context --json' for environment state before adding.".to_string(),
        state_changes: vec![
            StateChange {
                what: "Creates database entry".to_string(),
                how: "INSERT INTO sessions".to_string(),
                reversible: true,
                reverse_command: Some("zjj remove <name>".to_string()),
            },
            StateChange {
    ...
    commands.insert("list".to_string(), CommandDocumentation {
        ...
        usage: "zjj list [OPTIONS]".to_string(),
        arguments: vec![],
        options: vec![
            OptionDoc {
                name: "all".to_string(),
        ...
        examples: vec![
            ...
            Example {
                command: "zjj list --json | jq '.[] | select(.status == \"active\")'".to_string(),
                description: "Filter active sessions with jq".to_string(),
                use_case: "Programmatic filtering of sessions".to_string(),
            },
        ],
        prerequisites: vec!["zjj initialized in repository".to_string()],
        workflow_position: WorkflowPosition {
            typical_order: 0,
            comes_after: vec![],
            comes_before: vec![],
    ...
    commands.insert("remove".to_string(), CommandDocumentation {
        ...
        usage: "zjj remove [OPTIONS] <name>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: true,
        ...
        output_formats: vec!["human".to_string(), "json".to_string()],
        exit_codes: vec![0, 1, 2, 3],
        ai_guidance: "Use --dry-run to preview. Use --merge to integrate work before cleanup. Check 'zjj list' before removing.".to_string(),
        state_changes: vec![
            StateChange {
    ...
    commands.insert("focus".to_string(), CommandDocumentation {
        ...
        usage: "zjj focus <name>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: true,
        ...
        examples: vec![
            Example {
                command: "zjj focus feature-auth".to_string(),
        ...
        ai_guidance: "Use 'zjj list' to find available sessions. Cannot focus if not inside Zellij.".to_string(),
        state_changes: vec![],
    });
    ...
    commands.insert("status".to_string(), CommandDocumentation {
        ...
        usage: "zjj status [OPTIONS] [name]".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: false,
    ...
    commands.insert("sync".to_string(), CommandDocumentation {
        ...
        usage: "zjj sync [OPTIONS] [name]".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: false,
        ...
        output_formats: vec!["human".to_string(), "json".to_string()],
        exit_codes: vec![0, 1, 2, 3],
        ai_guidance: "Use --dry-run to preview. Check 'zjj diff' before and after sync to see changes.".to_string(),
        state_changes: vec![
            StateChange {
    ...
    commands.insert("diff".to_string(), CommandDocumentation {
        ...
        usage: "zjj diff [OPTIONS] <name>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "name".to_string(),
                required: true,
    ...
    commands.insert("config".to_string(), CommandDocumentation {
        ...
        long_description: "Manage zjj configuration. Can view entire config, get specific values, or set values. Supports both project-local (.zjj/config.toml) and global (~/.config/zjj/config.toml) configuration.".to_string(),
        usage: "zjj config [OPTIONS] [key] [value]".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "key".to_string(),
                required: false,
        ...
        state_changes: vec![
            StateChange {
                ...
                how: "Update .zjj/config.toml or ~/.config/zjj/config.toml".to_string(),
                reversible: true,
                reverse_command: Some("zjj config <key> <old_value>".to_string()),
            },
        ],
    });
    ...
    commands.insert("dashboard".to_string(), CommandDocumentation {
        ...
        usage: "zjj dashboard".to_string(),
        arguments: vec![],
        options: vec![],
        examples: vec![
            Example {
                command: "zjj dashboard".to_string(),
    ...
    commands.insert("context".to_string(), CommandDocumentation {
        ...
        usage: "zjj context [OPTIONS]".to_string(),
        arguments: vec![],
        options: vec![
            OptionDoc {
                name: "json".to_string(),
    ...
    commands.insert("introspect".to_string(), CommandDocumentation {
        ...
        long_description: "Provides detailed information about zjj commands, their arguments, options, and usage. Can show all commands or specific command details. Designed for command discovery and learning.".to_string(),
        usage: "zjj introspect [OPTIONS] [command]".to_string(),
        arguments: vec![
            ArgumentDoc {
        ...
        examples: vec![
            Example {
                ...
                use_case: "Discover what zjj can do".to_string(),
            },
            Example {
                command: "zjj introspect add".to_string(),
    ...
    commands.insert("doctor".to_string(), CommandDocumentation {
        ...
        usage: "zjj doctor [OPTIONS]".to_string(),
        arguments: vec![],
        options: vec![
            OptionDoc {
                name: "json".to_string(),
        ...
        examples: vec![
            ...
            Example {
                command: "zjj doctor --json".to_string(),
    ...
    commands.insert("query".to_string(), CommandDocumentation {
        ...
        usage: "zjj query <query_type> [args]".to_string(),
        arguments: vec![
            ArgumentDoc {
    ...
    commands.insert("completions".to_string(), CommandDocumentation {
        ...
        usage: "zjj completions <shell>".to_string(),
        arguments: vec![
            ArgumentDoc {
        ...
        examples: vec![
            Example {
                command: "zjj completions bash > ~/.local/share/bash-completion/completions/zjj".to_string(),
                description: "Generate bash completions".to_string(),
                use_case: "Enable tab completion in bash".to_string(),
            },
            Example {
                command: "zjj completions zsh --instructions".to_string(),
    ...
    commands.insert("backup".to_string(), CommandDocumentation {
        ...
        usage: "zjj backup [OPTIONS] [path]".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "path".to_string(),
                required: false,
                description: "Backup file path (default: .zjj/backups/zjj-backup-<timestamp>.json)".to_string(),
                validation_rules: vec![],
                examples: vec!["~/backups/zjj-sessions.json".to_string()],
            },
        ],
        options: vec![
            OptionDoc {
        ...
        examples: vec![
            ...
            Example {
                command: "zjj backup ~/backups/zjj-sessions.json".to_string(),
    ...
    commands.insert("restore".to_string(), CommandDocumentation {
        ...
        usage: "zjj restore [OPTIONS] <path>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "path".to_string(),
                required: true,
        ...
        examples: vec![
            Example {
                command: "zjj restore ~/backups/zjj-sessions.json".to_string(),
                description: "Restore from backup (with confirmation)".to_string(),
                use_case: "Recover from data loss".to_string(),
            },
            Example {
                command: "zjj restore backup.json --force".to_string(),
        ...
        state_changes: vec![
            StateChange {
                ...
                reversible: true,
                reverse_command: Some("zjj restore <auto-backup-file>".to_string()),
            },
        ],
    });
    ...
    commands.insert("verify-backup".to_string(), CommandDocumentation {
        ...
        usage: "zjj verify-backup [OPTIONS] <path>".to_string(),
        arguments: vec![
            ArgumentDoc {
                name: "path".to_string(),
                required: true,
        ...
        examples: vec![
            Example {
                command: "zjj verify-backup backup.json".to_string(),
                description: "Verify backup file".to_string(),
                use_case: "Check backup before restore".to_string(),
            },
            Example {
                command: "zjj verify-backup backup.json --json".to_string(),
    ...
    commands.insert("version".to_string(), CommandDocumentation {
        ...
        long_description: "Displays version information including zjj version, Rust version, build date, commit hash, and feature flags. Useful for bug reports and compatibility checking.".to_string(),
        usage: "zjj version [OPTIONS]".to_string(),
        arguments: vec![],
        options: vec![
            OptionDoc {
                name: "json".to_string(),
