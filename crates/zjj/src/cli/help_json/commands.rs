...
pub fn generate_command_docs() -> HashMap<String, CommandDocumentation> {
    hashmap! {
        // === INIT COMMAND ===
        "init".into() => CommandDocumentation {
            name: "init".to_string(),
            aliases: vector![],
            ...
            options: vector![
                ...
                OptionDoc {
                    ...
                    value_type: None,
                    default: None,
                    conflicts_with: vector!["force".into()],
                    requires: vector![],
                },
                OptionDoc {
                    ...
                    value_type: None,
                    default: None,
                    conflicts_with: vector!["repair".into()],
                    requires: vector![],
                },
            ],
            examples: vector![
            ...
            prerequisites: vector![
                "jj installed (https://github.com/martinvonz/jj)".into(),
                "zellij installed (https://zellij.dev)".into(),
                "Write permissions in current directory".into(),
            ],
            workflow_position: WorkflowPosition {
                typical_order: 1,
                comes_after: vector![],
                comes_before: vector!["add".into()],
                can_run_parallel_with: vector!["doctor".into(), "config".into()],
            },
            related_commands: vector!["doctor".into(), "config".into(), "backup".into(), "restore".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1, 2],
        ...
        "add".into() => CommandDocumentation {
            ...
            prerequisites: vector![
                "Must be in a JJ repository (run 'zjj init' first)".into(),
                "Must be inside Zellij session (unless using --no-open)".into(),
                "Session name must not already exist".into(),
            ],
            workflow_position: WorkflowPosition {
                typical_order: 2,
                comes_after: vector!["init".into()],
                comes_before: vector!["sync".into(), "remove".into()],
                can_run_parallel_with: vector!["list".into(), "status".into()],
            },
            related_commands: vector![
                "list".into(),
                "status".into(),
                "remove".into(),
                "sync".into(),
        ...
        // === LIST COMMAND ===
        "list".into() => CommandDocumentation {
            name: "list".to_string(),
            aliases: vector![],
            category: "Session Lifecycle".to_string(),
            ...
            prerequisites: vector!["zjj initialized in repository".into()],
            workflow_position: WorkflowPosition {
                typical_order: 0,
                comes_after: vector![],
                comes_before: vector![],
                can_run_parallel_with: vector!["add".into(), "status".into(), "focus".into()],
            },
            related_commands: vector!["add".into(), "status".into(), "focus".into(), "dashboard".into()],
            output_formats: vector!["table".into(), "silent".into(), "json".into()],
            exit_codes: vector![0, 2],
        ...
        // === REMOVE COMMAND ===
        "remove".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["feature-auth".into(), "bugfix-123".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            prerequisites: vector!["Session must exist".into()],
            workflow_position: WorkflowPosition {
                typical_order: 5,
                comes_after: vector!["add".into(), "sync".into()],
                comes_before: vector![],
                can_run_parallel_with: vector![],
            },
            related_commands: vector!["add".into(), "list".into(), "sync".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1, 2, 3],
        ...
        // === FOCUS COMMAND ===
        "focus".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["feature-auth".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            prerequisites: vector!["Session must exist".into(), "Must be inside Zellij".into()],
            workflow_position: WorkflowPosition {
                typical_order: 0,
                comes_after: vector!["add".into()],
                comes_before: vector![],
                can_run_parallel_with: vector![],
            },
            related_commands: vector!["list".into(), "add".into(), "dashboard".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 2, 3],
            ai_guidance: "Use 'zjj list' to find available sessions. Cannot focus if not inside Zellij.".to_string(),
            state_changes: vector![],
        },

        // === STATUS COMMAND ===
        "status".into() => CommandDocumentation {
            ...
            workflow_position: WorkflowPosition {
                ...
                comes_after: vector![],
                comes_before: vector![],
                can_run_parallel_with: vector!["list".into(), "add".into()],
            },
            related_commands: vector!["list".into(), "dashboard".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 2, 3],
        ...
        // === SYNC COMMAND ===
        "sync".into() => CommandDocumentation {
            name: "sync".to_string(),
            aliases: vector![],
            ...
            workflow_position: WorkflowPosition {
                typical_order: 4,
                comes_after: vector!["add".into()],
                comes_before: vector!["remove".into()],
                can_run_parallel_with: vector![],
            },
            related_commands: vector!["diff".into(), "add".into(), "remove".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1, 2, 3],
        ...
        // === DIFF COMMAND ===
        "diff".into() => CommandDocumentation {
            name: "diff".to_string(),
            aliases: vector![],
            category: "Workspace Sync".to_string(),
            ...
            related_commands: vector!["sync".into(), "status".into()],
            output_formats: vector!["diff".into(), "stat".into(), "json".into()],
            exit_codes: vector![0, 2, 3],
        ...
        // === CONFIG COMMAND ===
        "config".into() => CommandDocumentation {
            name: "config".to_string(),
            aliases: vector!["cfg".into()],
            category: "System".to_string(),
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["workspace_dir".into(), "default_template".into()],
                },
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["/custom/path".into(), "minimal".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            prerequisites: vector!["zjj initialized".into()],
            workflow_position: WorkflowPosition {
                typical_order: 0,
                comes_after: vector!["init".into()],
                comes_before: vector![],
            ...
            related_commands: vector!["init".into(), "doctor".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1, 2],
        ...
        // === DASHBOARD COMMAND ===
        "dashboard".into() => CommandDocumentation {
            name: "dashboard".to_string(),
            aliases: vector!["dash".into()],
            ...
            related_commands: vector!["list".into(), "status".into(), "focus".into()],
            output_formats: vector!["tui".into()],
            exit_codes: vector![0, 2],
        ...
        // === CONTEXT COMMAND ===
        "context".into() => CommandDocumentation {
            name: "context".to_string(),
            aliases: vector!["ctx".into()],
            category: "Introspection".to_string(),
            ...
            related_commands: vector!["introspect".into(), "doctor".into(), "status".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 2],
        ...
        // === INTROSPECT COMMAND ===
        "introspect".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["add".into(), "sync".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            related_commands: vector!["context".into(), "help".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0],
        ...
        // === DOCTOR COMMAND ===
        "doctor".into() => CommandDocumentation {
            name: "doctor".to_string(),
            aliases: vector!["check".into()],
            category: "System".to_string(),
            ...
            related_commands: vector!["init".into(), "config".into(), "context".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 2, 4],
        ...
        // === QUERY COMMAND ===
        "query".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["session-exists".into(), "session-count".into()],
                },
                ArgumentDoc {
                    name: "args".to_string(),
                    required: false,
            ...
            related_commands: vector!["list".into(), "context".into()],
            output_formats: vector!["text".into()],
            exit_codes: vector![0, 1],
            ai_guidance: "Use for validation before operations. Outputs simple text for easy parsing in scripts.".to_string(),
            state_changes: vector![],
        },

        // === COMPLETIONS COMMAND ===
        "completions".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["bash".into(), "zsh".into(), "fish".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            related_commands: vector![],
            output_formats: vector!["script".into()],
            exit_codes: vector![0, 1],
        ...
        // === BACKUP COMMAND ===
        "backup".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["~/backups/zjj-sessions.json".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            workflow_position: WorkflowPosition {
                typical_order: 0,
                comes_after: vector![],
                comes_before: vector!["restore".into()],
                can_run_parallel_with: vector![],
            },
            related_commands: vector!["restore".into(), "verify-backup".into(), "init".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 2],
        ...
        // === RESTORE COMMAND ===
        "restore".into() => CommandDocumentation {
            ...
            prerequisites: vector!["Valid backup file".into()],
            workflow_position: WorkflowPosition {
                typical_order: 0,
                comes_after: vector!["backup".into()],
                comes_before: vector![],
                can_run_parallel_with: vector![],
            },
            related_commands: vector!["backup".into(), "verify-backup".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1, 2],
        ...
        "verify-backup".into() => CommandDocumentation {
            ...
            arguments: vector![
                ArgumentDoc {
                    ...
                    validation_rules: vector![],
                    examples: vector!["backup.json".into()],
                },
            ],
            options: vector![
                OptionDoc {
            ...
            related_commands: vector!["backup".into(), "restore".into()],
            output_formats: vector!["human".into(), "json".into()],
            exit_codes: vector![0, 1],
        ...
        // === VERSION COMMAND ===
        "version".into() => CommandDocumentation {
