...
#[test]
#[ignore = "Watch mode runs continuously - not suitable for automated tests"]
fn test_status_with_watch_flag() {
    ...
    // Note: --watch will block indefinitely, monitoring for file changes
    // This test is marked #[ignore] to prevent blocking in CI/automated test runs
    // To test manually: cargo test test_status_with_watch_flag -- --ignored
