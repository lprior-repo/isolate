...
fn bdd_examples_contract_flag_does_not_panic() {
    ...
    //   When I run "zjj examples --contract"
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("AI CONTRACT for zjj examples"))
...
fn bdd_examples_contract_returns_valid_structure() {
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("zjj examples"))
