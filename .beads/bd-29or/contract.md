...
**Bead ID:** isolate-20260228091055-wueipm3j  
**Type:** bug  
**Priority:** P1  
**Effort Estimate:** 2hr
...
| Test Name | Given | When | Then |
|-----------|-------|------|------|
| test_status_invalid | Invalid inputs | User runs 'isolate status invalid' | Exit code is non-zero, Error message is clear |
| test_status_missing | Missing subcommand | User runs 'isolate status' | Exit code is non-zero, Help message shown |
