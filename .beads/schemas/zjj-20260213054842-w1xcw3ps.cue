...
// Validation schema for bead: zjj-20260213054842-w1xcw3ps
// Title: session-validation: move filesystem checks out of domain
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260213054842-w1xcw3ps.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260213054842-w1xcw3ps"
  title: "session-validation: move filesystem checks out of domain"
