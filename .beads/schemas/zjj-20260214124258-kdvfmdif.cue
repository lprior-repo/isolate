...
// Validation schema for bead: isolate-20260214124258-kdvfmdif
// Title: cli-consistency: implement phase 5 dry run 1
//
// This schema validates that implementation is complete.
// Use: cue vet isolate-20260214124258-kdvfmdif.cue implementation.cue

#BeadImplementation: {
  bead_id: "isolate-20260214124258-kdvfmdif"
  title: "cli-consistency: implement phase 5 dry run 1"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "bookmark --dry-run shows target but does not delete",
      "claim --dry-run shows plan",
    ]
