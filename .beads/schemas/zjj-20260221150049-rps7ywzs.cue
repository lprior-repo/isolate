...
#BeadImplementation: {
  ...
  contracts_verified: {
    ...
    precondition_checks: [
      "sort_by_priority exists",
      "stack_depth field exists",
    ]

    // Specific postconditions that must be verified
    postcondition_checks: [
      "Sort key includes stack_depth",
      "Lower depth sorts first",
    ]
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Same priority sorts by depth",
      "Depth 0 before depth 1",
    ]

    // Required error path tests
    required_error_tests: [
      "Missing depth defaults to 0 in sort",
      "NULL depth handled gracefully",
    ]
  }
