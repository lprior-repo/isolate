...
// Validation schema for bead: zjj-20260212132128-5fsypla9
// Title: worker: Add CLI args and loop/once orchestration
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-5fsypla9.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-5fsypla9"
  title: "worker: Add CLI args and loop/once orchestration"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Loop mode processes multiple items",
      "Once mode exits after one item",
      "Reclaim runs on startup",
    ]
