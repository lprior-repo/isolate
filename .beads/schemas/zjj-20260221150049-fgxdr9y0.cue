...
#BeadImplementation: {
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "parent_workspace column exists",
      "QueueEntry has parent_workspace field",
    ]

    // Specific invariants that must be maintained
    invariant_checks: [
      "parent_workspace is nullable",
    ]
  }
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      ...
      "Field deserializes from NULL",
      "Field deserializes from string value",
    ]

    // Required error path tests
    required_error_tests: [
      "Invalid string handled gracefully",
      "Missing column returns None not error",
    ]
  }
