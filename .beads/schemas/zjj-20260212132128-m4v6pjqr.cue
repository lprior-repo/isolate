...
// Validation schema for bead: zjj-20260212132128-m4v6pjqr
// Title: docs: Document JSON schemas for all commands
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-m4v6pjqr.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-m4v6pjqr"
  title: "docs: Document JSON schemas for all commands"
  ...
  tests_passing: {
    ...
    required_error_tests: [
      "Schema mismatches are caught",
      "Ambiguous formats are clarified",
    ]
  }
