...
// Validation schema for bead: zjj-20260212132128-v1ft7do0
// Title: queue-ops: Implement list command with FIFO ordering
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-v1ft7do0.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-v1ft7do0"
  title: "queue-ops: Implement list command with FIFO ordering"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "List shows all entries in order",
      "JSON output matches schema",
    ]

    // Required error path tests
    required_error_tests: [
      "Database error returns structured error",
