...
// Validation schema for bead: zjj-20260212132128-fcf7umai
// Title: tests: Add unit tests for lease claim and reclaim
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-fcf7umai.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-fcf7umai"
  title: "tests: Add unit tests for lease claim and reclaim"
  ...
  tests_passing: {
    ...
    required_error_tests: [
      ...
      "Wrong owner heartbeat fails",
      "Reclaim of active lease fails",
    ]
  }
