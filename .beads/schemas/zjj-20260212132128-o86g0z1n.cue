...
// Validation schema for bead: zjj-20260212132128-o86g0z1n
// Title: queue-core: Implement lease claim, heartbeat, and reclaim APIs
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-o86g0z1n.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-o86g0z1n"
  title: "queue-core: Implement lease claim, heartbeat, and reclaim APIs"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Successful claim sets lease fields",
      "Heartbeat extends lease expiration",
      "Stale lease reclamation succeeds",
    ]

    // Required error path tests
    required_error_tests: [
      "Claiming already-claimed entry fails",
