...
// Validation schema for bead: zjj-20260212132128-cpnzgcf2
// Title: worker: Implement claim pipeline and state transitions
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-cpnzgcf2.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-cpnzgcf2"
  title: "worker: Implement claim pipeline and state transitions"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Claim succeeds and entry progresses",
      "All state transitions emit events",
    ]

    // Required error path tests
    required_error_tests: [
      "Claim race resolves correctly",
      "Invalid transition fails entry",
    ]
  }
