...
// Validation schema for bead: zjj-20260213054842-hystypfq
// Title: session-validation: remove duplicated name-length branch
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260213054842-hystypfq.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260213054842-hystypfq"
  title: "session-validation: remove duplicated name-length branch"
