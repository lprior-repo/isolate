...
// Validation schema for bead: zjj-20260212132128-nq5xqx1t
// Title: queue-core: Implement database schema migration for state machine and dedupe keys
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-nq5xqx1t.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-nq5xqx1t"
  title: "queue-core: Implement database schema migration for state machine and dedupe keys"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      ...
      "Migration from old schema succeeds",
    ]
