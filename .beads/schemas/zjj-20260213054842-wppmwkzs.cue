...
// Validation schema for bead: zjj-20260213054842-wppmwkzs
// Title: session-model: introduce session-name value-object
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260213054842-wppmwkzs.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260213054842-wppmwkzs"
  title: "session-model: introduce session-name value-object"
