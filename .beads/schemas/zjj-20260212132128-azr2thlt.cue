...
// Validation schema for bead: zjj-20260212132128-azr2thlt
// Title: queue-ops: Implement cancel command
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-azr2thlt.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-azr2thlt"
  title: "queue-ops: Implement cancel command"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Cancel stops pending entry",
      "Cancel releases active claim",
    ]

    // Required error path tests
    required_error_tests: [
      "Cancel merged entry fails",
