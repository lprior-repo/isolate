...
// Validation schema for bead: zjj-20260213055521-qwtiyubv
// Title: session-model: introduce session-name value-object
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260213055521-qwtiyubv.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260213055521-qwtiyubv"
  title: "session-model: introduce session-name value-object"
