...
#BeadImplementation: {
  ...
  contracts_verified: {
    ...
    precondition_checks: [
      "ExitCode enum or pattern exists",
    ]

    // Specific postconditions that must be verified
    postcondition_checks: [
      "Exit codes defined for stack errors",
      "Documented in help",
    ]
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "CycleDetected returns specific code",
      "ParentNotFound returns specific code",
    ]

    // Required error path tests
    required_error_tests: [
      "Unknown error returns generic error code",
      "Exit code 0 only for success",
    ]
  }
