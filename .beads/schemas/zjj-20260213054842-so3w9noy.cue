...
// Validation schema for bead: zjj-20260213054842-so3w9noy
// Title: queue-infra: split sqlx entities from domain queue models
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260213054842-so3w9noy.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260213054842-so3w9noy"
  title: "queue-infra: split sqlx entities from domain queue models"
