...
// Validation schema for bead: zjj-20260212132128-mybqg3kr
// Title: docs: Draft operator runbook for queue operations
//
// This schema validates that implementation is complete.
// Use: cue vet zjj-20260212132128-mybqg3kr.cue implementation.cue

#BeadImplementation: {
  bead_id: "zjj-20260212132128-mybqg3kr"
  title: "docs: Draft operator runbook for queue operations"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "All commands have runbook entries",
      "Troubleshooting is comprehensive",
    ]

    // Required error path tests
    required_error_tests: [
      "Missing procedures are identified",
      "Unclear instructions are clarified",
    ]
  }
