...
spec: {
	...
	spawn_workspace: {
		...
		trigger: "user invokes 'isolate spawn <bead-id>'"
		command: "isolate spawn <bead-id>"
		expected_result: "New workspace created, agent started"
	}

	done_workspace: {
		description: "Complete work and merge workspace to main"
		trigger: "user invokes 'isolate done'"
	...
	doctor: {
		...
		trigger: "user invokes 'isolate doctor'"
		command: "isolate doctor"
		expected_result: "Health report displayed"
	}

	dashboard: {
		description: "Launch interactive TUI dashboard"
		trigger: "user invokes 'isolate dashboard'"
		command: "isolate dashboard"
...
constraints: {
	...
	tab_naming: "Zellij tabs SHALL be named 'isolate:<session-name>'"
